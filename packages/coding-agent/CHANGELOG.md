...
- Fixed a crash in subagent task execution and extensions when a string (instead of a string array) was returned or set for the system prompt. String values are now gracefully wrapped in arrays.
