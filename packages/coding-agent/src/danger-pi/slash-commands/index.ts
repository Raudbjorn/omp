...
import { screenshotSlashCommand } from "./screenshot";
 ...
 */
export const dangerPiBundledBuiltinSlashCommands: ReadonlyArray<BuiltinSlashCommandSpec> = [
	gentitleSlashCommand,
	screenshotSlashCommand,
];
