...
export const sanitizeSchemaForGoogle = normalizeSchemaForGoogle;
export const sanitizeSchemaForCCA = normalizeSchemaForCCA;
export const sanitizeSchemaForMCP = normalizeSchemaForMCP;
export const prepareSchemaForCCA = normalizeSchemaForCCA;
