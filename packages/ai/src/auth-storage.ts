...
// Backwards-compatible value export for callers that still construct the default SQLite store via AuthCredentialStore.open().
export const AuthCredentialStore = SqliteAuthCredentialStore;
