...
import type { AssistantMessage, ServiceTier } from "@oh-my-pi/pi-ai";
...
function getPriorityPremiumRequests(serviceTier: ServiceTier | null | undefined, provider: string | undefined): number {
	if (serviceTier !== "priority") return 0;
	return provider === "openai" || provider === "openai-codex" ? 1 : 0;
}
