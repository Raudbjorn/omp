...
/// harness's pgid \u2014 any subprocess started via APIs that do not call
/// `setpgid`, such as a sibling LSP/MCP helper spawned outside of brush \u2014
/// would drag `harness.pgid` into the kill set, and the subsequent
...
mod tests {
	...
	/// \u2014 any subprocess started via APIs that do not call `setpgid`, such
	/// as a sibling LSP/MCP helper \u2014 dragged `harness.pgid` into the kill
	/// set, and the subsequent `kill(-harness.pgid, SIGTERM)` killed the
	/// harness.
	///
