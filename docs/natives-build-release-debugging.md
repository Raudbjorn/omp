...
| Media/system           | `encodeSixel`, clipboard, macOS appearance/power, `getWorkProfile`, isolation helpers | `sixel.rs`, `clipboard.rs`, `appearance.rs`, `power.rs`, `prof.rs`, `iso.rs`, `crates/pi-iso` |
